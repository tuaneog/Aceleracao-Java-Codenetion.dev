...
public class Motorista {
    ...
    public static class MotoristaBuilder {
        ...
        public MotoristaBuilder withIdade(int idade) {
            if (idade < 0) throw new IllegalArgumentException("Necessário informar idade");
            this.idade = idade;
            return this;
        }
        ...
        public MotoristaBuilder withPontos(int pontos) {
            if(pontos < 0){
                throw new IllegalArgumentException("Pontos negativos na carteira");
            }
            this.pontos = pontos;
            return this;
        }
        ...
        public Motorista build() throws NullPointerException, EstacionamentoException {
            if (Objects.isNull(nome)) throw new NullPointerException("Nome deve ser informado");
            if (Objects.isNull(habilitacao)) throw new NullPointerException("Habilitação deve ser informada");
            if (idade < 18) throw new EstacionamentoException("Motorista deve ter idade para habilitação");
