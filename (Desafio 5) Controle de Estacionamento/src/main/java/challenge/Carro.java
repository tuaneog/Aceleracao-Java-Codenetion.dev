...
public class Carro {
    ...
    public static class CarroBuilder {
        ...
        public Carro build() throws NullPointerException, EstacionamentoException {
            if(Objects.isNull(placa)) throw new NullPointerException("Informe a placa do carro");
            if(Objects.isNull(cor)) throw new NullPointerException("Informe uma cor válida");
            if(Objects.isNull(motorista)) throw new EstacionamentoException("O carro não deve ser autônomo");
